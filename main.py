...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("-tipall ") and user.username == "_.Tavsann._":
              parts = message.split(" ")
              if len(parts) != 2:
        ...
        if message.lower().startswith("-tipme ") and user.username== "_.Tavsann._":
                try:
        ...
        if              message.startswith("Fairyfloat All") or                              message.startswith("/emote all fairyfloat") or       message.startswith("!emote all fairyfloat"):
          if user.username == "FallonXOXO" or user.username == "_.Tavsann._":
        ...
        if              message.startswith("Launch All") or                              message.startswith("/emote all launch") or       message.startswith("!emote all launch"):
          if user.username == "_.Tavsann._" or user.username == "RayMG":
            roomUsers = (await self.highrise.get_room_users()).content
            for roomUser, _ in roomUsers:
